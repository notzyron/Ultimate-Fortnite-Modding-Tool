...
area2_obj.light_linking.receiver_collection = bpy.data.collections.get("area1_receivers")
area2_obj.light_linking.receiver_collection = character_collection
area3_obj.light_linking.receiver_collection = bpy.data.collections.get("area1_receivers")
area3_obj.light_linking.receiver_collection = character_collection
area4_obj.light_linking.receiver_collection = bpy.data.collections.get("area1_receivers")
