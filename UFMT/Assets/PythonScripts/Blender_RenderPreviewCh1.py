...
cam_obj.location = (-0.196425, -6.32585, 0.901527)
cam_obj.rotation_euler[0] = math.radians(90.2279)
cam_obj.rotation_euler[1] = math.radians(1.22801)
cam_obj.rotation_euler[2] = math.radians(6.40155)
bpy.context.scene.camera = cam_obj

area1_data = bpy.data.lights.new(name="area1_data", type="AREA")
area1_obj = bpy.data.objects.new("area1", area1_data)
bpy.context.collection.objects.link(area1_obj)
area1_obj.location = (-0.859621, -0.886659, 2.44756)
area1_obj.rotation_euler[0] = math.radians(-8.60427)
area1_obj.rotation_euler[1] = math.radians(-46.7647)
area1_obj.rotation_euler[2] = math.radians(55.7184)
area1_data.energy = 50
area1_data.size = 1
area1_data.use_shadow = False #Idk Ch1 graphics aren't really realistic so turn off shadows on the main light
...
area2_obj.location = (-1.05805, 1.44972, 1.50753)
area2_obj.rotation_euler[0] = math.radians(-85.1567)
area2_obj.rotation_euler[1] = math.radians(-9.33519)
area2_obj.rotation_euler[2] = math.radians(4.39104)
area2_data.energy = 100
area2_data.size = 1
...
sun_data.energy = 4
sun_obj.rotation_euler[0] = math.radians(-8.98311)
sun_obj.rotation_euler[1] = math.radians(8.06809)
sun_obj.rotation_euler[2] = math.radians(-26.1908)
...
cr_elements[1].position = 0.730909
